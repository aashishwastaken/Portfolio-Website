...
export default function Contact() {
    return (
        ...
        <div id="contact-methods" className="row">
          ...
          <footer><p>Built By <FontAwesomeIcon icon={faTools} />
          <a href="https://www.linkedin.com/in/aashishwastaken/" target="_blank" rel="noreferrer" >AashishWasTaken</a></p></footer>
